...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, meta_data, im_info=None, gt_boxes=None, num_boxes=None, run_partial=False, is_first=False):
...
def concat_all_gather(tensor):
    ...
    *** Warning ***: torch.distributed.all_gather has no gradient.
    ...
    return nn.parallel.gather(tensor, 0, dim=0)